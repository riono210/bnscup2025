...
//	Array<int> messageRead;
	...
	Array<String> Text =
	{
		...
		// 99 嫉妬の大罪の絵
		U"この部屋には、もう一人いた。",
		U"その人の笑顔を、壁の隙間から何度も見た。どうしてあの光は、自分には向かないのだろう。",
		U"いつしか、影の中が居場所になった。そして、見つめることだけが、生きる理由になった。",
		...
		U"誰も答えない夜が続き、やがて拳だけが言葉になった。",
		U"壁は沈黙を守り、男の中で何かが壊れた。",
		...
		U"彼女は愛されるたびに、自分が削れていくのを感じていたという。",
		U"それでも、誰かの眼差しがないと、生きていることさえ確かめられなかった。",
		...
		U"ベッドは沈み、部屋は荒んでいる。この部屋の時は、とうに止まったままだ。",
		U"それでも、窓の外では朝が来て、何事もなかったように、埃だけが光を受けていた。",
